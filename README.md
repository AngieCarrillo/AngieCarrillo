...
📍 **Mexico** | 🚀 **Founder & Angel Investor** | 🤖 **Building with AI**
...
I build tools to solve real problems, then share the process. 
Investment thesis: AI-native only companies where AI is the product, not a feature.
...
- Trained 500 girls to build mobile apps with Technovation and a UNESCO grant and Fundacion Telefonica.
- Swimmer, runner, cyclist. Training for a marathon.
- Lived in Peru, Mexico, Brazil, the US, and the UK. 30+ countries visited.
- Powered by Colombian coffee and always with my rescued-dog diva.
